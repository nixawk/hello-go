...
// Runner runs a set of tasks within a given timeout and can be shutdown on an
...
type Runner struct {
	...
	// tasks holds a set of functions that are executed synchronously in
	// index order.
	tasks []func(int)
}
...
var ErrInterrupt = errors.New("received message")
