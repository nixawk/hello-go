// This sample program demonstrates how to use a channel to monitor the amount
...
// createTask returns an example task that sleeps for the specified number of
// seconds based on the id.
